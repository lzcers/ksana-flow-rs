        ...
        <div className="relative z-10 w-full max-w-5xl mx-auto px-6">
          ...
          >
            <div className="max-w-2xl mx-auto text-center">
              <h1 className="font-serif text-4xl md:text-5xl tracking-wider mb-3 text-glow">
              ...
              <div className="game-card p-4 mb-8 text-left">
            ...
            <div className="game-card p-4 md:p-6 mb-6 bg-background/30">
              ...
              <div className="grid gap-4 lg:grid-cols-[minmax(0,1.15fr)_minmax(0,0.85fr)] lg:items-start">
                <div className="game-card p-4 md:p-5 text-left">
            ...
            <div className="space-y-3">
              <motion.button
                ...
                whileTap={{ scale: 0.98 }}
                className="w-full game-btn-primary py-4 flex items-center justify-center gap-2"
              >
