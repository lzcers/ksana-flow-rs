export const textNodeStyles = {
    ...
    previewBox:
        "w-full flex-1 text-xs bg-zinc-900/60 border border-zinc-800 rounded shadow-inner overflow-y-auto overflow-x-hidden nodrag nowheel text-zinc-200 custom-scrollbar select-text",
    editTextarea:
    ...
    fullscreenContainer: "w-full h-full flex p-4 text-zinc-200 text-sm overflow-auto custom-scrollbar bg-zinc-900/70 justify-center items-center",
