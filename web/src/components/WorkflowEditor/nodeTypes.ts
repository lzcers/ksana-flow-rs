import { Sparkles, Database, Activity, Box, Type, Mail, Timer, FileText, GitMerge, Clapperboard, Image } from 'lucide-react';
...
export const NODE_TYPES: { type: NodeType; label: string; icon: any; color: string }[] = [
  ...
  { type: 'ImgGenNode', label: 'Image', icon: Image, color: 'text-emerald-500 bg-emerald-50' },
