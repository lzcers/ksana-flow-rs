import { Sparkles, Hexagon, Database, Activity, Box, Type, Mail, Timer, FileText, GitMerge } from 'lucide-react';
...
export const NODE_TYPES: { type: NodeType; label: string; icon: any; color: string }[] = [
  ...
  { type: 'StreamLLMNode', label: 'LLM', icon: Hexagon, color: 'text-purple-500 bg-purple-50' },
